...
describe("patchSecureAuthEmailTemplates", () => {
  it("replaces verification and password reset content with branded templates", () => {
    ...
    expect(verification.subject).toContain("Verify your email — Thiago Goulart de Oliveira");
    ...
    expect(reset.subject).toContain("Reset your password — Thiago Goulart de Oliveira");
